                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    {{ $association->secteur->name ?? 'Non défini' }}
                                </span>
                                ...
                                <div class="text-xs text-gray-500">
                                    <span class="font-medium text-gray-700">Agrément:</span>
                                    {{ $association->numero_agrement ?? 'N/A' }}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                                    ...
                                    <div class="font-semibold text-gray-900">{{ $association->nombreBeneficiaire }}
                                    </div>
                                    ...
                                    <div class="font-semibold text-emerald-600">
                                        {{ number_format($association->budget_annuel, 0, ',', ' ') }} <span
                                            class="text-xxs">DH</span></div>
                                </div>
                            </td>
