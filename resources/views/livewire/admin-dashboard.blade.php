        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Admin Dashboard 🛠️</h1>
                        <p class="text-gray-600 mt-2">Manage your application and users from here.</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">Recently registered users in the system.</p>
                </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="space-y-3">
                        ...
                        <button class="w-full text-left px-4 py-3 bg-green-50 hover:bg-green-100 rounded-md transition duration-150 ease-in-out">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-green-900">System Settings</span>
